...
function mem_info(mem_info) {
	document.getElementById("mem_percent").innerText = mem_info["data"]['percent'];
   document.getElementById("mem_total").innerText = mem_info["data"]['total'];
   document.getElementById("mem_used").innerText = mem_info["data"]['used'];
   document.getElementById("mem_free").innerText = mem_info["data"]['free'];
